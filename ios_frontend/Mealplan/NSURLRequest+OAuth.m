...
static NSString * const kConsumerKey       = @"g6XBsl1Pv_jDFwzJyI2_OA";
static NSString * const kConsumerSecret    = @"6PRBlVDrVGPKqNf5-NkuwQySVAQ";
static NSString * const kToken             = @"TmvxKFkhyvOYPfdFU8a1jFK6kj3H-Fsc";
static NSString * const kTokenSecret       = @"aiNT4BeohwRwE8ddMAfY_OCzI_k";
